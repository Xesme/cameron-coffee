 ...
 */
function custom_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['custom_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('custom_theme sample setting'),
  '#default_value' => theme_get_setting('custom_theme_example'),
